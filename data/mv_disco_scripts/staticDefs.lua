...
dvsd.CREW_STAT_DEFINITIONS = {
    ...
    HUMAN_ENGINEER = {INTELLECT=3, logic=1, encylopedia=1, conceptualization=1, PSYCHE=3, inland_empire=1, PHYSIQUE=3, MOTORICS=3, hand_eye_coordination=1, interfacing=1},
    ...
    HUMAN_SOLDIER = {INTELLECT=3, visual_calculus=1, PSYCHE=3, authority=1, espirit_de_corps=1, PHYSIQUE=3, endurance=1, pain_threshold=1, physical_instrument=1, half_light=1, MOTORICS=3, hand_eye_coordination=1, reaction_speed=1, composure=1},
    HUMAN_MFK = {INTELLECT=4, visual_calculus=2, conceptualization=2, PSYCHE=4, authority=2, espirit_de_corps=2, PHYSIQUE=4, endurance=2, pain_threshold=2, physical_instrument=2, half_light=2, MOTORICS=4, hand_eye_coordination=2, reaction_speed=2, composure=2},
    ENGI = {INTELLECT=4, logic=1, PSYCHE=3, empathy=-1, espirit_de_corps=2, PHYSIQUE=1, MOTORICS=3, interfacing=1},
    ENGI_SEPERATIST = {INTELLECT=4, logic=1, PSYCHE=3, espirit_de_corps=-2, PHYSIQUE=1, MOTORICS=3, interfacing=1},
    ENGI_DEFENDER = {INTELLECT=4, logic=1, PSYCHE=3, PHYSIQUE=2, endurance=3, pain_threshold=3, MOTORICS=2, composure=3},
    ZOLTAN = {INTELLECT=3, PSYCHE=4, PHYSIQUE=2, MOTORICS=3},
    ROCK = {INTELLECT=3, PSYCHE=3, volition=1, PHYSIQUE=4, endurance=1, pain_threshold=1, half_light=1, MOTORICS=2, composure=2},
    ROCK_OUTCAST = {INTELLECT=3, PSYCHE=3, volition=1, espirit_de_corps=-1, PHYSIQUE=4, endurance=1, pain_threshold=1, half_light=1, MOTORICS=2, composure=2},
    ROCK_CULTIST = {INTELLECT=3, PSYCHE=3, volition=1, inland_empire=1, PHYSIQUE=4, endurance=1, pain_threshold=1, half_light=1, MOTORICS=2, composure=1},
    ROCK_COMMANDO = {INTELLECT=3, PSYCHE=4, volition=1, espirit_de_corps=1, PHYSIQUE=4, endurance=2, pain_threshold=1, half_light=1, MOTORICS=2, composure=3},
    ROCK_CRUSADER = {INTELLECT=3, rhetoric=2, PSYCHE=4, volition=1, espirit_de_corps=1, PHYSIQUE=4, endurance=2, pain_threshold=1, half_light=1, MOTORICS=2, composure=4},
    ROCK_PALADIN = {INTELLECT=3, PSYCHE=5, volition=1, authority=2, espirit_de_corps=2, PHYSIQUE=5, endurance=3, pain_threshold=2, half_light=2, MOTORICS=2, composure=5},
    CRYSTAL = {INTELLECT=3, PSYCHE=4, authority=1, PHYSIQUE=4, MOTORICS=3, composure=1},
    CRYSTAL_SENTINAL = {INTELLECT=4, PSYCHE=6, authority=1, PHYSIQUE=6, MOTORICS=2, composure=4},
    CRYSTAL_LIBERATOR = {INTELLECT=4, PSYCHE=6, authority=1, PHYSIQUE=6, MOTORICS=2, composure=4},
    MANTIS = {INTELLECT=2, PSYCHE=2, PHYSIQUE=4, MOTORICS=3, reaction_speed=1, interfacing=-2},
    FREE_MANTIS = {INTELLECT=2, PSYCHE=3, PHYSIQUE=4, electrochemistry=1, endurance=-1, MOTORICS=3, reaction_speed=1, interfacing=-2},
    FREE_MANTIS_CHAOS = {INTELLECT=2, PSYCHE=3, PHYSIQUE=4, electrochemistry=2, endurance=-1, MOTORICS=3, reaction_speed=1, interfacing=-2},
    FREE_MANTIS_WARLORD = {INTELLECT=3, PSYCHE=3, PHYSIQUE=5, electrochemistry=2, endurance=-1, MOTORICS=4, reaction_speed=1, interfacing=-2},
    MANTIS_SUZERAIN = {INTELLECT=4, PSYCHE=3, PHYSIQUE=6, MOTORICS=3, reaction_speed=1, interfacing=-2},
    MANTIS_BISHOP = {INTELLECT=5, PSYCHE=5, PHYSIQUE=6, MOTORICS=4, reaction_speed=1, interfacing=-2},
    SLUG = {INTELLECT=4, PSYCHE=3, drama=1, empathy=-1, suggestion=1, PHYSIQUE=3, MOTORICS=3, perception=1},
    SLUG_HEKTAR = {INTELLECT=4, PSYCHE=3, drama=1, empathy=-1, suggestion=1, PHYSIQUE=3, MOTORICS=3, perception=1},
    SLUG_SABOTUER = {INTELLECT=4, PSYCHE=4, drama=1, empathy=-1, suggestion=2, PHYSIQUE=5, MOTORICS=4, savoir_faire=2},
    SLUG_RANGER = {INTELLECT=5, PSYCHE=5, drama=1, empathy=-1, suggestion=1, PHYSIQUE=6, MOTORICS=5, perception=2},
    SLUG_CLANSMAN = {INTELLECT=5, PSYCHE=4, drama=2, empathy=-1, suggestion=1, PHYSIQUE=5, MOTORICS=5, perception=1},
    KNIGHT_OF_NIGHTS = {INTELLECT=7, PSYCHE=7, empathy=-2, authority=1, PHYSIQUE=6, MOTORICS=6, perception=2},
    ORCHID = {INTELLECT=3, PSYCHE=3, empathy=1, PHYSIQUE=3, electrochemistry=1, MOTORICS=3},
    ORCHID_PRAETOR = {INTELLECT=4, logic=1, encylopedia=1, rhetoric=1, drama=1, PSYCHE=4, empathy=-1, authority=1, PHYSIQUE=3, pain_threshold=-1, MOTORICS=3, composure=1},
    ORCHID_CARETAKER = {INTELLECT=3, encylopedia=1, rhetoric=1, conceptualization=1, visual_calculus=1, PSYCHE=4, empathy=3, PHYSIQUE=3, electrochemistry=1, MOTORICS=3, composure=1},
    ...
    SHELL = {INTELLECT=5, PSYCHE=3, volition=1, PHYSIQUE=2, electrochemistry=2, MOTORICS=3},
    SHELL_SCIENTIST = {INTELLECT=6, PSYCHE=3, volition=1, PHYSIQUE=2, electrochemistry=2, MOTORICS=3},
    SHELL_MECHANIC = {INTELLECT=5, PSYCHE=3, volition=1, PHYSIQUE=2, electrochemistry=1, MOTORICS=3, interfacing=1},
    SHELL_GUARDIAN = {INTELLECT=4, PSYCHE=4, volition=1, PHYSIQUE=5, electrochemistry=2, MOTORICS=3, interfacing=-1},
    SHELL_RADIANT = {INTELLECT=5, PSYCHE=5, volition=1, PHYSIQUE=4, electrochemistry=2, MOTORICS=5},
    LEECH = {INTELLECT=3, PSYCHE=1, PHYSIQUE=2, endurance=2, pain_threshold=1, MOTORICS=4, composure=-1},
    AMPERE = {INTELLECT=3, PSYCHE=2, PHYSIQUE=3, endurance=2, pain_threshold=1, MOTORICS=5, composure=-1},
    SIREN = {INTELLECT=3, PSYCHE=4, empathy=-4, inland_empire=2, PHYSIQUE=3, half_light=1, MOTORICS=3},
    HARPY = {INTELLECT=3, PSYCHE=5, empathy=-4, inland_empire=3, PHYSIQUE=4, half_light=2, MOTORICS=3},
    LANIUS = {INTELLECT=3, encylopedia=1, PSYCHE=3, volition=2, espirit_de_corps=-1, PHYSIQUE=4, MOTORICS=3, interfacing=1}, --idk what to do with them.
    WELDER = {INTELLECT=3, encylopedia=1, PSYCHE=3, volition=2, PHYSIQUE=4, MOTORICS=4, interfacing=1, reaction_speed=-2},
    AUGMENTED = {INTELLECT=4, encylopedia=1, PSYCHE=3, volition=3, PHYSIQUE=4, endurance=-2, MOTORICS=4, interfacing=1},
    GHOST = {INTELLECT=3, PSYCHE=3, PHYSIQUE=3, MOTORICS=3, savoir_faire=2},
    GHOST_BIG = {INTELLECT=4, PSYCHE=4, PHYSIQUE=5, MOTORICS=3, savoir_faire=2},
    GAS_HATCHLING = {INTELLECT=1, PSYCHE=2, PHYSIQUE=1, MOTORICS=3, interfacing=-3, composure=-3},
    GAS_ADULT = {INTELLECT=2, PSYCHE=4, PHYSIQUE=4, physical_instrument=1, half_light=1, MOTORICS=1, hand_eye_coordination=3, perception=2, reaction_speed=3},
    GAS_WEAVER = {INTELLECT=5, PSYCHE=6, PHYSIQUE=3, shivers=1, half_light=1, MOTORICS=5, savoir_faire=-1},
    GAS_VENOM = {INTELLECT=2, PSYCHE=3, PHYSIQUE=4, electrochemistry=2, shivers=5, half_light=5, MOTORICS=4},
    GAS_QUEEN = {INTELLECT=3, visual_calculus=5, PSYCHE=7, PHYSIQUE=10, MOTORICS=4, hand_eye_coordination=4, perception=4, reaction_speed=4, interfacing=-3},
    LIZARD = {INTELLECT=2, drama=3, PSYCHE=3, inland_empire=1, PHYSIQUE=3, MOTORICS=4, composure=-2},
    ...
    COGNITIVE = {INTELLECT=5, rhetoric=-3, drama=-3, PSYCHE=0, PHYSIQUE=6, MOTORICS=4},
    COGNITIVE_AUTOMATED = {INTELLECT=5, rhetoric=-3, drama=-3, PSYCHE=4, PHYSIQUE=6, MOTORICS=4},
    COGNITIVE_ADVANCED = {INTELLECT=8, rhetoric=-3, drama=-3, PSYCHE=0, PHYSIQUE=6, MOTORICS=6},
    COGNITIVE_ADVANCED_AUTOMATED = {INTELLECT=8, rhetoric=-3, drama=-3, PSYCHE=4, PHYSIQUE=6, MOTORICS=6},
    OBELISK = {INTELLECT=6, PSYCHE=4, empathy=-2, PHYSIQUE=6, MOTORICS=4, interfacing=-3},
    --DARKEST DESIRE
    OBELISK_ROYAL = {INTELLECT=7, PSYCHE=6, empathy=-2, PHYSIQUE=6, physical_instrument=1, MOTORICS=4, composure=3, interfacing=-3},
    DEEP_ONE = {INTELLECT=3, PSYCHE=4, PHYSIQUE=5, shivers=1, half_light=1, MOTORICS=3},
    DEEP_ONE_CULTIST = {INTELLECT=3, PSYCHE=4, inland_empire=1, PHYSIQUE=5, shivers=1, half_light=1, MOTORICS=3},
    THE_SCARRED = {INTELLECT=5, PSYCHE=6, inland_empire=2, PHYSIQUE=6, shivers=1, half_light=1, MOTORICS=4},
    THE_SCARRED_ASCENDED = {INTELLECT=5, PSYCHE=10, PHYSIQUE=6, shivers=1, half_light=1, MOTORICS=6},
    ENLIGHTENED_HORROR = {INTELLECT=3, PSYCHE=4, inland_empire=4, PHYSIQUE=5, half_light=2, MOTORICS=4},
    --PONY_ENGI = {INTELLECT=3, PSYCHE=4, PHYSIQUE=6, MOTORICS=4},
    --OUTER EXPANSION
    ...
    LEAH = {INTELLECT=3, PSYCHE=3, volition=3, PHYSIQUE=3, MOTORICS=3},
    ...
    TYREDO = {INTELLECT=4, PSYCHE=3, PHYSIQUE=4, MOTORICS=5}, --Just copy his stats to the bird to avoid dumb dillution --todo don't do that
...
dvsd.CREW_STAT_TABLE = {
    ...
    aea_bird_unique
    --]]
    fff_f22={INTELLECT=3, visual_calculus=1, PSYCHE=2, espirit_de_corps=3, PHYSIQUE=4, pain_threshold=1, half_light=-1, MOTORICS=2, hand_eye_coordination=-1, reaction_speed=8, composure=-2},
    fff_buffer={INTELLECT=3, rhetoric=-1, drama=1, conceptualization=1, PSYCHE=4, PHYSIQUE=3, MOTORICS=3, composure=1},
    fff_omen={INTELLECT=3, encylopedia=1, PSYCHE=3, volition=1, inland_empire=4, suggestion=2, PHYSIQUE=3, endurance=2, pain_threshold=1, electrochemistry=2, shivers=2, MOTORICS=1, perception=4, savoir_faire=3, interfacing=3, composure=3},
