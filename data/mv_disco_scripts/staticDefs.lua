...
dvsd.CREW_STAT_DEFINITIONS = {
    ...
    ROCK = {INTELLECT=3, PSYCHE=3, volition=1, PHYSIQUE=4, endurance=1, pain_threshold=1, MOTORICS=2, composure=2},
    ROCK_OUTCAST = {INTELLECT=3, PSYCHE=3, volition=1, espirit_de_corps=-1, PHYSIQUE=4, endurance=1, pain_threshold=1, MOTORICS=2, composure=2},
    ROCK_CULTIST = {INTELLECT=3, PSYCHE=3, volition=1, inland_empire=1, PHYSIQUE=4, endurance=1, pain_threshold=1, MOTORICS=2, composure=1},
    ROCK_COMMANDO = {INTELLECT=3, PSYCHE=4, volition=1, espirit_de_corps=1, PHYSIQUE=4, endurance=2, pain_threshold=1, MOTORICS=2, composure=3},
    ROCK_CRUSADER = {INTELLECT=3, rhetoric=2, PSYCHE=4, volition=1, espirit_de_corps=1, PHYSIQUE=4, endurance=2, pain_threshold=1, MOTORICS=2, composure=4},
    ROCK_PALADIN = {INTELLECT=3, PSYCHE=5, volition=1, authority=2, espirit_de_corps=2, PHYSIQUE=6, endurance=3, pain_threshold=1, MOTORICS=2, composure=5},
    ...
    MANTIS = {INTELLECT=2, PSYCHE=2, PHYSIQUE=4, MOTORICS=3, interfacing=-2},
    FREE_MANTIS = {INTELLECT=2, PSYCHE=3, PHYSIQUE=4, electrochemistry=1, endurance=-1, MOTORICS=3, interfacing=-2},
    FREE_MANTIS_CHAOS = {INTELLECT=2, PSYCHE=3, PHYSIQUE=4, electrochemistry=2, endurance=-1, MOTORICS=3, interfacing=-2},
    FREE_MANTIS_WARLORD = {INTELLECT=3, PSYCHE=3, PHYSIQUE=5, electrochemistry=2, endurance=-1, MOTORICS=4, interfacing=-2},
    MANTIS_SUZERAIN = {INTELLECT=4, PSYCHE=3, PHYSIQUE=6, MOTORICS=3, interfacing=-2},
    MANTIS_BISHOP = {INTELLECT=5, PSYCHE=5, PHYSIQUE=6, MOTORICS=4, interfacing=-2},
    SLUG = {INTELLECT=4, PSYCHE=3, suggestion=1, PHYSIQUE=3, MOTORICS=3},
    SLUG_HEKTAR = {INTELLECT=4, PSYCHE=3, suggestion=1, PHYSIQUE=3, MOTORICS=3},
    SLUG_SABOTUER = {INTELLECT=4, PSYCHE=4, suggestion=2, PHYSIQUE=5, MOTORICS=6},
    SLUG_RANGER = {INTELLECT=5, PSYCHE=5, suggestion=1, PHYSIQUE=6, MOTORICS=6},
    SLUG_CLANSMAN = {INTELLECT=5, PSYCHE=4, suggestion=1, PHYSIQUE=5, MOTORICS=5},
    ...
    SHELL_MECHANIC = {INTELLECT=5, PSYCHE=3, PHYSIQUE=2, electrochemistry=1, MOTORICS=3, interfacing=1},
    SHELL_GUARDIAN = {INTELLECT=4, PSYCHE=4, PHYSIQUE=5, electrochemistry=2, MOTORICS=3},
    ...
    AUGMENTED = {INTELLECT=4, PSYCHE=3, PHYSIQUE=4, MOTORICS=4},
    ...
    COGNITIVE = {INTELLECT=5, PSYCHE=0, PHYSIQUE=6, MOTORICS=4},
    COGNITIVE_AUTOMATED = {INTELLECT=5, PSYCHE=4, PHYSIQUE=6, MOTORICS=4},
    ...
    OBELISK = {INTELLECT=6, PSYCHE=4, PHYSIQUE=6, MOTORICS=4, interfacing=-1},
    --DARKEST DESIRE
    OBELISK_ROYAL = {INTELLECT=7, PSYCHE=6, PHYSIQUE=6, physical_instrument=1, MOTORICS=4, composure=3, interfacing=-1},
    DEEP_ONE = {INTELLECT=3, PSYCHE=4, PHYSIQUE=5, MOTORICS=3},
    DEEP_ONE_CULTIST = {INTELLECT=3, PSYCHE=4, inland_empire=1, PHYSIQUE=5, MOTORICS=3},
    THE_SCARRED = {INTELLECT=5, PSYCHE=6, inland_empire=2, PHYSIQUE=6, MOTORICS=4},
    THE_SCARRED_ASCENDED = {INTELLECT=5, PSYCHE=10, PHYSIQUE=6, MOTORICS=6},
    ENLIGHTENED_HORROR = {INTELLECT=3, PSYCHE=4, inland_empire=4, PHYSIQUE=6, MOTORICS=4},
    --PONY_ENGI = {INTELLECT=3, PSYCHE=4, PHYSIQUE=6, MOTORICS=4},
    --OUTER EXPANSION
